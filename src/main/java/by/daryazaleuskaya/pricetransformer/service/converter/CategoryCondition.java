...
public class CategoryCondition {
    ...
    public static final BiPredicate<String, String> UNISEX_SOCKS_CONDITION = (name, articleNumber) -> isMan(name) && name.equalsIgnoreCase("носки");
    ...
    public static final BiPredicate<String, String> GIRL_LIFE_CONDITION = (name, articleNumber) -> isGirl(name) && articleNumber.startsWith("1");
    ...
    public static final BiPredicate<String, String> BOY_LIFE_CONDITION = (name, articleNumber) -> isBoy(name) && articleNumber.startsWith("1");
    ...
    public static final BiPredicate<String, String> CHILD_TIGHTS_CONDITION = (name, articleNumber) -> isBoy(name) && contains(name,"колготки детские");
