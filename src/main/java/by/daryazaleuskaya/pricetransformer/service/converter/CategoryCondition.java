...
public class CategoryCondition {
    ...
    public static final BiPredicate<String, String> WOMAN_LIFE_CONDITION = (name, articleNumber) ->
            isWoman(name) && articleNumber.startsWith("1");
    public static final BiPredicate<String, String> WOMAN_SPORT_CONDITION = (name, articleNumber) ->
            isWoman(name) && articleNumber.startsWith("3");
    ...
    public static final BiPredicate<String, String> WOMAN_UNDERWEAR_CONDITION = (name, articleNumber) ->
            isWoman(name) && (articleNumber.startsWith("4") || articleNumber.startsWith("5"))
                    && (contains(name, "трусы") || contains(name, "бюстгальтер")
                    || contains(name, "бюстье") || contains(name, "майка") || contains(name, "топ"));
    ...
    public static final BiPredicate<String, String> GIRL_UNDERWEAR_CONDITION = (name, articleNumber) -> isGirl(name)
            && (contains(name, "плавки")
            || contains(name, "топ")
            || contains(name, "майка")
            || contains(name, "трусы"));
    public static final BiPredicate<String, String> GIRL_BEACH_CONDITION = (name, articleNumber) -> isGirl(name)
            && articleNumber.startsWith("7");
    public static final BiPredicate<String, String> GIRL_TERMO_CONDITION = (name, articleNumber) -> isGirl(name)
            && contains(name, "термо");

    public static final BiPredicate<String, String> BOY_HOME_CONDITION = (name, articleNumber) -> isBoy(name)
            && articleNumber.startsWith("5");
    public static final BiPredicate<String, String> BOY_LIFE_CONDITION = (name, articleNumber) -> isBoy(name)
            && (articleNumber.startsWith("1") || articleNumber.startsWith("3"));
    public static final BiPredicate<String, String> BOY_UNDERWEAR_CONDITION = (name, articleNumber) -> isBoy(name)
            && (contains(name, "плавки")
            || contains(name, "трусы")
            || contains(name, "майка"));
    public static final BiPredicate<String, String> BOY_BEACH_CONDITION = (name, articleNumber) -> isBoy(name)
            && articleNumber.startsWith("7");
    public static final BiPredicate<String, String> BOY_TERMO_CONDITION = (name, articleNumber) -> isBoy(name)
            && contains(name, "термо");
    ...
    public static final BiPredicate<String, String> ACCESSORIES_CONDITION = (name, articleNumber) ->
            contains(name, "резинки") || contains(name, "заколки");
    public static final BiPredicate<String, String> PACKAGE_CONDITION = (name, articleNumber) ->
            contains(name, "пакет") || contains(name, "коробка");
